...
import { AiFillLayout, AiOutlineSearch } from "react-icons/ai";
...
const Home = () => {
  ...
  return (
    <div className="flex bg-stone-50">
      <div
        className={`relative duration-300 h-screen p-5 pt-8 bg-white rounded-l-lg ${
          open ? "w-72" : "w-20"
        } `}
      >
        <BsArrowLeftShort
      ...
      <div className="flex-1">
        <div className="w-full h-10">
          <div className="flex justify-between pr-4">
            <div className="flex items-center pl-8 rounded-md p-2.5">Path</div>
            <div className="flex items-center py-4 pl-8 rounded-md p-2.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block p-2 pl-10 text-sm text-gray-900 bg-white border rounded-lg shadow-md w-80 border-1 focus:outline-none"
                  placeholder="Search"
                />
              </div>
            </div>
