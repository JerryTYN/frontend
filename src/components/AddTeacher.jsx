...
const AddTeacher = ({ visible, userInfo, onClose }) => {
      ...
      <div className="w-full h-full max-w-2xl md:h-auto">
        <div action="#" className="relative bg-white rounded-lg shadow ">
            ...
            <div className="grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  required
                  //   value={name}
                  //   disabled={userInfo ? userInfo.roles === "User" : false}
                ...
                <div class="flex ">
                  <div class="mb-3 w-full">
                    ...
                    <select
                      ...
                      //   disabled={userInfo ? userInfo.roles === "User" : false}
                      //   onChange={(e) => {
                      //     setFaculty(parseInt(e.target.value));
                      //   }}
                    >
          ...
          <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b ">
            <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Thêm
            </button>
          </div>
        </div>
