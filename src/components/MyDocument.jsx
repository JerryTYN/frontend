        ...
        <View className="flex p-10 m-10"style={styles.section}>
          <div className="flex flex-col w-full space-y-4">
            ...
            <div className="flex pl-4 space-x-16 text-sm text-gray-500">
              <Text>Tổng số tín chỉ: {data && data.totalCredits}</Text>
              <Text>Lý thuyết: {data && data.theoryCredits}</Text>
              <Text>Thực hành: {data && data.practiceCredits}</Text>
              <Text>Tự học: {data && data.selfLearningCredits}</Text>
            </div>
            ...
            <Text className="pt-8 text-sm font-bold text-gray-600">
              Ngày biên soạn/ cập nhật:
            </Text>
            <Text className="pt-8 pl-8 text-sm font-bold text-gray-600">
              Trưởng bộ môn
            </Text>
          </div>
        </View>
