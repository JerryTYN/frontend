      ...
      <div className="flex-row w-[1100px] h-[600px] bg-white overflow-auto pl-6 pr-6  rounded ">
        ...
        <div className="flex flex-col w-full h-full space-y-4 pt-10">
          ...
          <div className="flex items-center justify-end space-x-6 pb-8">
            <button className="w-[90px] h-12 border rounded-lg text-center bg-green-500 border-gray-100 text-gray-50 font-semibold hover:bg-green-300 hover:text-gray-800">Lưu</button>
            <button className="w-[90px] text-gray-50 h-12 bg-blue-500 border rounded-lg text-center border-gray-100 hover:bg-blue-300 hover:text-gray-800 font-semibold">Xem lại</button>
          </div>
        </div>
      </div>
    </div>
